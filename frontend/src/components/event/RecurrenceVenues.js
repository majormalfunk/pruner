...
const RecurrenceVenues = (props) => {

  const { displaySuccess, displayInfo, displayError, currentUser, unfinishedRecurrence,
    updateInOwnEvents, updateRecurrenceVenue, show, setEvent } = props
...
export default connect(mapStateToProps, mapDispatchToProps)(RecurrenceVenues)